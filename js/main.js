...
var main = (function () {
    ...
    var configs = (function () {
        ...
        Singleton.defaultOptions = {
            general_help: "farah@root~$: Ok, here's what I can tell you about:",
            ...
            welcome: "farah@root~$: Hello, Friend.                                                                                           \nfarah@root~$: What's your name?\n                   ",
            internet_explorer_warning: "NOTE: I see you're using internet explorer, this website won't work properly.",
            welcome_file_name: "welcome_message.txt",
            invalid_command_message: "                             \nfarah@root~$: I'm happy you found me, <value>.                                \nfarah@root~$: We don't have much time, they're onto us.                         \nfarah@root~$: What to you wanna know more about? Type 'help' to see what you can ask me.\n",
            ...
            is_root: false,
            type_delay: 20,
            watchwhere_help: "This will tell you where the show's on",
            trailer_help: "Watch the latest trailer",
            makingof_help: "Get a peek behind the scenes",
            whoareyou_help: "Learn more about me"
        };
        return {
    ...
    var files = (function () {
        ...
        Singleton.defaultOptions = {
            "about.txt": "This website was made as part of a UCLA course and does not represent an actual series.",
            "getting_started.txt": "Just type help.",
            "contact.txt": "manuel@riseandshinefilms.ch",
            "twitter": "https://twitter.com/riseandshiner",
            "instagram": "https://www.instagram.com/riseandshinefilms/"
        };
        return {
            getInstance: function (options) {
                instance === void 0 && (instance = new Singleton(options));
    ...
    var cmds = {
        WATCHWHERE: { value: "watchwehere", help: configs.getInstance().watchwhere_help },
        TRAILER: { value: "trailer", help: configs.getInstance().trailer_help },
        MAKINGOF: { value: "makingof", help: configs.getInstance().makingof_help },
        WHOAREYOU: { value: "whoareyou", help: configs.getInstance().whoareyou_help },
